...
<html lang="en">
  <head>
    ...
    <title>Company Profile | Ngoding Mastery</title>
  </head>
  <body id="home">
    <!-- todo Navbar -->
    <div class="navbar">
    ...
    <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
        @auth
            <a href="{{ url('/home') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition duration-300 ease-in-out">Home</a>
        @else
            <a href="{{ route('login') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition duration-300 ease-in-out">Log in</a>

            @if (Route::has('register'))
                <a href="{{ route('register') }}" class="ml-4 bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition duration-300 ease-in-out">Register</a>
            @endif
        @endauth
    </div>
@endif
    ...
    <div class="header">
      <div class="header-box">
        ...
        <div class="hero-img">
          <img src="assets/img/desktop.jpg" alt="unsplash.com" />
          <img src="assets/img/iot.jpg" alt="unsplash.com" />
          <img src="assets/img/mobile.jpg" alt="unsplash.com" />
          <img src="assets/img/website.jpg" alt="unsplash.com" />
        </div>
      ...
      <div class="container">
        <div class="services-box">
          <div class="box">
            ...
            <p data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Beatae, quos pariatur! Mollitia atque veritatis perspiciatis ratione magni, doloribus fuga nihil.</p>
          </div>
          <div class="boxes">
            <div class="boxs">
            ...
            <div class="boxs">
              ...
              <img src="assets/img/mobile.jpg" alt="" data-aos="zoom-in" data-aos-duration="1000" />
            </div>
            <div class="boxs">
              <img src="assets/img/iot.jpg" alt="" data-aos="zoom-in" data-aos-duration="1000" />
              <div class="desc" data-aos="fade-up" data-aos-duration="1000">
                <h1>
                  IOT <br />
                  Development
      ...
      <div class="container">
        <div class="contact-box">
          <div class="box">
            ...
            <h1>Contact Kami</h1>
            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Impedit rerum delectus enim facilis illo inventore perspiciatis laudantium repellat officia nulla!</p>
          </div>
      ...
      <div class="container">
        <div class="footer-box">
          <div class="box">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam quia adipisci iste harum sapiente, aspernatur obcaecati corporis dolores aliquam dignissimos.</p>
          </div>
          <div class="box">
            <a href="#home">Home</a>
    ...
    <div class="copyright">
      <div class="container">
        <div class="copy-box">
          <p>&copy; Copyright 2022 by Ngoding Mastery, All Right Reserved.</p>
